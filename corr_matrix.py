...
corr_mat = loadmat('r_val_4220.mat')
def cluster(correlation_matrix):
    ...
    map_test=sns.clustermap(df, row_linkage=row_linkage, col_linkage=col_linkage,cmap='bwr',  method="average", xticklabels=1, figsize=(15,15), annot_kws={"size": 6})
