...
def adjust_press_idx(Data,Down_idx, Up_idx, plot=False):
    ...
    if plot:
        ...
        plt.scatter(new_Down_idx, magnet[new_Down_idx], c='b')
        plt.scatter(new_Up_idx, magnet[new_Up_idx], c='r')
        for [a,b, v] in zip (new_Down_idx, new_Up_idx, magnet[new_Down_idx]):
            plt.hlines(v,a,b)
